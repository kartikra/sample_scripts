...
--	HCCLSC_USHARE.KPCC_UPGRADE_MANIFEST		contains the table and column change info from the upgrade manifest spreadsheet
...
-- -----------------------------------------------------------------------------------------
-- ----------------------------------------------------------------------------------------- 
DROP TABLE MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES;
CREATE SET TABLE MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES,
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES
...
DROP TABLE MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS;	
CREATE SET TABLE MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS,
	     NO BEFORE JOURNAL,
	     NO AFTER JOURNAL,
	     CHECKSUM = DEFAULT
	     (
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS
SELECT *
from DBC.COLUMNS t2
where t2.databasename in ('MY_REPORT_DB','MY_MATVIEW_DB','MY_STAGE_DB','MY_USERDB',
				'MY_EPICDB','MY_LEAD_REPORTDB','MY_LEAD_STAGEDB')
...
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN TABLENAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN (TABLENAME,COLUMNNAME,CM_PHY_OWNER_ID);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN (TABLENAME,COLUMNNAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN (COLUMNNAME,CM_PHY_OWNER_ID);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN (TABLENAME,CM_PHY_OWNER_ID);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN (DBNAME,TABLENAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN COLUMNNAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS COLUMN CM_PHY_OWNER_ID;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES COLUMN DATABASENAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES COLUMN TABLEKIND;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES COLUMN TABLENAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES COLUMN (DATABASENAME ,TABLENAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES COLUMN (CREATORNAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS COLUMN (DATABASENAME ,TABLENAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS COLUMN (TABLENAME ,COLUMNNAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS COLUMN COLUMNNAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS COLUMN TABLENAME;

COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN TABLENAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_ISSUES COLUMN ERR_NO;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_ISSUES COLUMN (ERR_NO,DBNAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_ISSUES COLUMN DBNAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_TABLES COLUMN CM_PHY_OWNER_ID;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_TABLES COLUMN TABLENAME;

COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN CHG_TYPE;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN (TABLENAME,COLUMNNAME ,NEW_DATATYPE ,TESTING_RQRD);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN NEW_DATATYPE;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN COLUMNNAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN (TABLENAME,COLUMNNAME);
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD COLUMN TESTING_RQRD;
...
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_MANIFEST COLUMN CHG_TYPE;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_STG_TBLS COLUMN TABLENAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_STG_TBLS COLUMN CM_PHY_OWNER_ID;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS_views COLUMN TABLENAME;
COLLECT STATISTICS MY_USHAREDB.KPCC_UPGRADE_COLUMNS_views COLUMN COLUMNNAME;
...
DELETE FROM MY_USHAREDB.KPCC_UPGRADE_ISSUES 
...
-- ---------------------------------------------- 
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, dbname, runname, create_dttm) VALUES 
...
-- ------------------------------------------------ 
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, dbname, runname, create_dttm) 
SELECT -99,'UPGRADE_COLUMNS table is empty', 'MY_REPORT_DB','MY_RUNNAME', CURRENT_TIMESTAMP(0)
FROM 	(SELECT COUNT(*) recs FROM MY_USHAREDB.KPCC_UPGRADE_COLUMNS) AS b
WHERE 	b.recs = 0;

INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, dbname, runname, create_dttm) 
SELECT -99,'UPGRADE_TABLES table is empty', 'MY_REPORT_DB','MY_RUNNAME', CURRENT_TIMESTAMP(0)
FROM 	(SELECT COUNT(*) recs FROM MY_USHAREDB.KPCC_UPGRADE_TABLES) AS b
WHERE 	b.recs = 0;

INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, dbname, runname, create_dttm) 
SELECT -99,'UPGRADE_COLUMNS_VIEWS table is empty', 'MY_REPORT_DB','MY_RUNNAME', CURRENT_TIMESTAMP(0)
FROM 	(SELECT COUNT(*) recs FROM MY_USHAREDB.KPCC_UPGRADE_COLUMNS_views) AS b
WHERE 	b.recs = 0;
...
-- --------------------------------------------------------- 
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, columnname)
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS c1
		INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t2
...
WHERE	NOT EXISTS (
			SELECT 1
			FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c2
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, dbname, runname, create_dttm) 
	...
	FROM 	MY_USHAREDB.KPCC_UPGRADE_ISSUES 
	WHERE 	dbname IN ( 'MY_REPORT_DB','MY_MATVIEW_DB')
	AND 	err_no = 2;
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c1
		-- ------------------------------------------------ 
		-- only check tables if in USHARE list and database 
		-- ------------------------------------------------ 
		INNER JOIN (
			SELECT dbname, tablename 
			FROM MY_USHAREDB.KPCC_UPGRADE_COLUMNS 
		...
		AND NOT EXISTS (
			SELECT 	1
			FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS c3
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, tablename)
SELECT 	4, 'Table in USHARE list but not in reporting database' msg, 'MY_RUNNAME', 'MY_REPORT_DB', t1.tablename
FROM	MY_USHAREDB.KPCC_UPGRADE_TABLES t1
		-- ------------------------------------- 
		-- check if this error should be skipped 
		-- ------------------------------------- 
WHERE	4 NOT IN (0)
...
FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t2
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename)
...
FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t1
...
AND	NOT EXISTS
		(SELECT 1 
		FROM	MY_USHAREDB.KPCC_UPGRADE_TABLES t2
...
-- --------------------------------------------------------- 
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES
...
FROM (SELECT
    ...
    FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS c1
			...
			-- -------------------------------------------------------------------- 
			INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c2
...
FROM 	MY_USERDB.CLARITY_COL c1
		INNER JOIN MY_USERDB.CLARITY_TBL t1
			...
			AND EXISTS (
				SELECT	1
				FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t 
		...
		LEFT OUTER JOIN (
			...
			FROM 	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD
...
WHERE 	NOT EXISTS (
		SELECT 	1
		FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS t3
...
FROM	MY_USHAREDB.UPGRADE_DB_OWNER_LINK link
		...
		INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t1
...
FROM (
	SELECT	
		...
		c1.format_item
	FROM	
		MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c2
		-- ---------------------------------- 
...
WHERE	c1.cm_phy_owner_id = 'MY_OWNER_ID'
		...
		AND NOT EXISTS (
			SELECT 	1 
			FROM 	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD mt 
...
-- -----------------------------------------
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, 
...
FROM 	(select databasename, tablename, columnname
		FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS 
...
WHERE EXISTS (
		...
		AND EXISTS (
			SELECT 	1 
			FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS AS ush
		...
		AND NOT EXISTS 
			(SELECT 1 
			FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS c2 
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_TABLES AS t2 
...
AND		NOT EXISTS (
			SELECT	1
			FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES tbl
...
FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t1
WHERE t1.databasename IN ('MY_REPORT_DB','MY_MATVIEW_DB')
	-- ---------------------------- 
	-- exclude test and work tables 
	-- ---------------------------- 
...
AND NOT EXISTS (
		SELECT	1
		FROM 	MY_USHAREDB.KPCC_UPGRADE_TABLES tbl
...
-- -----------------------------------------------------------------
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, 
...
FROM	(SELECT	
	...
	FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS c1
		...
		-- -------------------------------------------------------------------------
		LEFT OUTER JOIN MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD chg
...
SELECT  80,  'Column Modify in Manifest but not in database' msg, 
		...
		a.ushare_def, chg.new_datatype AS mfst_def, a.db_def, chg.testing_rqrd
FROM	(Select * From MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD chg
	...
	FROM 	MY_USHAREDB.KPCC_UPGRADE_COLUMNS c1
		...
		AND 	not exists (
					SELECT 1 
					from MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD mu
...
AND 	EXISTS (
			SELECT	1
			FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c9
...
UPDATE MY_USHAREDB.KPCC_UPGRADE_ISSUES
FROM 
(select 	c2.databasename as dbname, c2.tablename as tblname, c2.columnname,
		...
		CASE WHEN c2.columntype IN ('CO', 'CV', 'CF') THEN '('||TRIM(c2.columnlength (FORMAT 'zzzzzzz'))||')'
			...
			ELSE COALESCE(c2.columntype, '')
		END AS "DB_SIZE"
from 	MY_USHAREDB.KPCC_UPGRADE_ISSUES a,
		MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c2
where 	a.err_no=80
...
where MY_USHAREDB.KPCC_UPGRADE_ISSUES.tablename =a1.tblname
and MY_USHAREDB.KPCC_UPGRADE_ISSUES.dbname=a1.dbname
AND MY_USHAREDB.KPCC_UPGRADE_ISSUES.columnname=A1.columnname
AND err_no=80
;
...
(select 	c1.dbname as dbname, c1.tablename as tblname, c1.columnname,
		...
		END AS "USHARE_SIZE"
from 	MY_USHAREDB.KPCC_UPGRADE_ISSUES a,
		MY_USHAREDB.KPCC_UPGRADE_COLUMNS c1
where 	a.err_no=80
...
-- -------------------------------------------------------------
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename,  testing_rqrd, slno)
SELECT	
...
FROM	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD AS chg
...
AND		EXISTS (
			SELECT	1
			FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES c
			WHERE	c.tablename = chg.tablename
			AND 	c.databasename in ('MY_REPORT_DB','MY_MATVIEW_DB') )
AND		NOT EXISTS (
			SELECT	1
			FROM 	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD m2
...
FROM	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD m
...
AND		EXISTS (
			SELECT 1
			FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES AS t2
...
AND		NOT EXISTS (
			SELECT 	1 
			FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c
...
-- ----------------------------------------------------------------
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, columnname, testing_rqrd, slno)
...
FROM 	( 
		...
		-- ------------------------------------------
		INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c
...
SELECT	86, 'Table Add in manifest but table not in database', 
		...
		TRIM(m.tablename) tablename,  
		m.testing_rqrd, m.slno
from 	MY_USHAREDB.KPCC_UPGRADE_MANIFEST m
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, stg_db, tablename,
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, stg_db, stg_table,
		is_preserved, on_demand, is_extracted, data_retained,cm_phy_owner_id, is_deprecated, tbl_ini)
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, columnname, stg_db, stg_table, tbl_ini)
SELECT 	103, 'Reporting table has column not found in staging table.' msg,'MY_RUNNAME', 'MY_REPORT_DB', 
		...
		COALESCE(NULLIF(tbl.chronicles_mf,'N/A'), NULLIF(tbl.dependent_ini,'N/A'), SUBSTR(tbl.extract_filename, 1,3)) AS tbl_ini
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS t2
		-- ---------------------------------------------
		...
		-- --------------------------------------------------------------------
		INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t3
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, tablename, columnname, stg_db, stg_table, tbl_ini)
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS t2
		...
		INNER JOIN (
			SELECT	tablename
			FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES 
			WHERE	databasename IN ('MY_REPORT_DB','MY_MATVIEW_DB')
			GROUP BY 1) t3
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, stg_db, stg_table, columnname, hccl_or_T_def,
...
FROM (SELECT	
	...
	FROM MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c1
		...
		-- ------------------------------------------------------------ 
		INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS stg 
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, issue_comment)
SELECT 	109, 'Staging Table in USHARE list but not in staging database' msg, 'MY_RUNNAME', 'MY_REPORT_DB', 
		...
		CASE 
			...
			WHEN mt.chg_type = 'Table Drop' and mt.recs = 2 Then 'Table converted to view per Upgrade Manifest'
		END as issue_comment
FROM	MY_USHAREDB.KPCC_UPGRADE_STG_TBLS t1
		-- ----------------------------------------
...
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, stg_db, tablename, issue_comment)
...
WHERE	NOT EXISTS (
			SELECT	1 
			FROM	MY_USHAREDB.KPCC_UPGRADE_STG_TBLS t2 
			WHERE 	t2.cm_phy_owner_id = 'MY_OWNER_ID'
			AND		t2.tablename = t1.tablename
			AND		t1.databasename in ('MY_STAGE_DB'))
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_STG_COLUMNS c1
		INNER JOIN MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t2
		ON c1.tablename = t2.tablename
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c1
		...
		INNER JOIN (
			SELECT dbname, tablename 
			FROM MY_USHAREDB.KPCC_UPGRADE_STG_COLUMNS 
			WHERE cm_phy_owner_id IN ('MY_OWNER_ID', '9001') 
			GROUP BY 1,2) AS t1
		ON UPPER(TRIM(c1.tablename)) = t1.tablename
		...
		AND NOT EXISTS (
			SELECT 	1
			FROM 	MY_USHAREDB.KPCC_UPGRADE_STG_COLUMNS c3
			WHERE 	c3.tablename = c1.tablename
			AND		c3.columnname = c1.columnname
			AND 	c3.cm_phy_owner_id IN ('MY_OWNER_ID', '9001') );
...
,'IMG_ORD_VIEW'
	...
	AND NOT EXISTS (
		SELECT 	1 
		FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES AS t3 
...
,'IMG_ORD_VIEW'
	...
	AND NOT EXISTS (
		SELECT 1
		FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t3
		WHERE 	t3.databasename IN ('MY_REPORT_DB','MY_MATVIEW_DB', 'MY_LEAD_REPORTDB')
		AND 	t3.tablename = t2.tablename);
...
FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS AS c2
	-- ------------------------------------------------------------
	-- only check for table if the table is valid for the deployment
	-- ------------------------------------------------------------
	INNER JOIN (
...
FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS AS c
WHERE 	c.databasename = 'MY_EPICDB'
		-- ------------------------------------------------------------
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES t0
...
,'IMG_ORD_VIEW'
		...
		AND NOT EXISTS (
			SELECT 	1
			FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES AS ut
...
,'IMG_ORD_VIEW'
		...
		AND NOT EXISTS (
			SELECT	1
			FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES AS tr
...
-- --------------------------------------------------------- 
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, columnname, issue_comment)
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c
		LEFT OUTER JOIN (
			...
			FROM	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD mt1
			WHERE 	mt1.chg_type in ('Col Add','Column Add')
			AND 	NOT EXISTS (
						SELECT 1 
						FROM MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD mt2 
...
FROM	MY_USHAREDB.KPCC_UPGRADE_COLUMNS_views v1
		-- ---------------------------------------------- 
...
-- ----------------------------------------------------------------------------------- 
INSERT INTO MY_USHAREDB.KPCC_UPGRADE_ISSUES (err_no, err_msg, runname, dbname, erroring_dbname, tablename, columnname, issue_comment, testing_rqrd)
...
FROM 	MY_USHAREDB.KPCC_UPGRADE_DBC_COLUMNS c
		...
		INNER JOIN (
			SELECT tablename 
			FROM MY_USHAREDB.KPCC_UPGRADE_COLUMNS_views 
			GROUP BY 1) AS v
		...
		LEFT OUTER JOIN	MY_USHAREDB.KPCC_UPGRADE_MANIFEST_LOAD mt
...
FROM	MY_USHAREDB.KPCC_UPGRADE_DBC_TABLES DTL
