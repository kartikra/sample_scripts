...
-- ------------------------------------------------------------------
INSERT INTO MY_USHAREDB.UPGRADE_TABLES 
SELECT
...
-- ---------------------------------------------------------------------------------------
INSERT INTO MY_USHAREDB.UPGRADE_COLUMNS
...
INSERT INTO MY_USHAREDB.UPGRADE_COLUMNS_VIEWS
...
-- ---------------------------------------------------------------------------------------
INSERT INTO MY_USHAREDB.UPGRADE_STG_TBLS	
SELECT 
	databasename, 
	tablename, 	
	CURRENT_DATE,
...
UPDATE 	MY_USHAREDB.UPGRADE_STG_TBLS
SET 	dbname = MY_USHAREDB.UPGRADE_DB_OWNER_LINK.stg_db
where 	MY_USHAREDB.UPGRADE_STG_TBLS.cm_phy_owner_id = MY_USHAREDB.UPGRADE_DB_OWNER_LINK.cm_phy_owner_id;
...
-- Run this sql and save the results to a file (ie. upgrade_columns_<rgn>_prod.txt)
-- ---------------------------------------------------------------------------------------
INSERT INTO MY_USHAREDB.UPGRADE_STG_COLUMNS
SELECT	TRIM(databasename), UPPER(TRIM(tablename)), UPPER(TRIM(columnname)), TRIM(columntype), TRIM(columnlength) (INTEGER), 
		TRIM(decimaltotaldigits) (INTEGER), TRIM(decimalfractionaldigits) (INTEGER), TRIM(compressible), TRIM(nullable),
CURRENT_DATE,
	CASE
